...
class Add_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_id.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def insert_book(self):
        try:
            ...
            if title == '' or author == '' or publisher == '':
                ...
                query = f'insert into tbl_addbook (title, author, publisher)  VALUE (%s, %s, %s)'
                value = (title, author, publisher)
            ...
            e = connect_to_db(self)
            self.label_result.setText('Failed to add book' + str(e))
            self.label_result.setStyleSheet('color:red')
