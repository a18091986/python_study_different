...
class NotePadWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.actionExport_PDF.triggered.connect(self.file_export_pdf)
        self.actionQuite.triggered.connect(self.quite)
        ...
        self.actionUndeline.triggered.connect(self.text_underline)
    ...
    def file_open(self):
        fname = QFileDialog.getOpenFileName(self, 'Open File', 'name_of_file')
    ...
    def preview_dialog(self):
        printer = QPrinter(QPrinter.PrinterMode.HighResolution)
        previwDialog = QPrintPreviewDialog(printer, self)
        previwDialog.paintRequested.connect(self.print_preview)
        previwDialog.exec()

    def print_preview(self, printer):
        self.textEdit.print(printer)

    def file_export_pdf(self):
        fn, _ = QFileDialog.getSaveFileName(self, 'Export PDF', 'name_of_file (.pdf) ;; All Files()')
    ...
    def about(self):
        QMessageBox.about(self, 'About App', 'ЁБТИТЬ')
